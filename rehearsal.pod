...
Prompt of the interactive shell in regular expression, e.g. '>>> ' for python (note the trailing space).

=item -ps2 I<regexp>

Multi-line continuation prompt in regular expression, e.g. '\.\.\. ' for python (note the escaping).
